...
// Served same-origin: netlify.toml proxies /media/* to the source CDNs in
// production, and the vite dev-server plugin redirects them in development.
// The source URLs live in media-sources.json.
const VIDEOS = [
...
const OVERLAY_PNG = '/media/overlay.png';
